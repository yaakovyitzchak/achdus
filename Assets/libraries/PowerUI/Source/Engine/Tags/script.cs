...
namespace PowerUI{
	...
	public class HtmlScriptElement:HtmlElement{
		...
		private void LoadContent(){
            ...
            /*	DataPackage package=new DataPackage(/*Src,document.basepath"http://localhost:770/myscript.js");
                ...
                package.onerror = (err) => {
                    UnityEngine.Debug.Log(err.@char);
                };

                package.send();*/
			//	UnityEngine.Debug.Log("gee loo yim here" + Src);
            new Achdus.Giluy(
				Src, 
				new System.Action<object, string>((res, err) => {
                ...
                // The element is still somewhere on the UI.
                if(err != null) {
                    UnityEngine.Debug.Log("ERR in loading: " + err);
                }
                if (res != null) {
               ...
               //     Engine.Compile(code);
                  ...
                  /*  onload = new System.Action<Event>((e) => {
                        UnityEngine.Debug.Log("WOWasdf");
                    });

                    onload = new System.Action<Event>((e) => {
                        UnityEngine.Debug.Log("gagsWOWasdf");
                    });*/
