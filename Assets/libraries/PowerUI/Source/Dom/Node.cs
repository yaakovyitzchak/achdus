...
namespace Dom{
	...
	public partial class Node : EventTarget, IParentNode{
        ...
        public void SetGlobal() {
            if (id != null) {
                Achdus.Yaakov.addToFinishedLoadingQue(() => {
                                var engine = PowerUI.UI.document.JavascriptEngine.Engine;
                                engine.SetValue(id, MyDegel());
        ...
        private Node MyDegel() {
            return Achdus.Yaakov.GetById(id);
        }
