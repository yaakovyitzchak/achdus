...
namespace PowerUI{
	...
	public static class ImageResizer{
        ...
        public static Texture2D Resize(Texture2D original, float ratio) {
            return Resize(original, ratio, ratio);
        }
		/// <summary>Resize the given image with the given scale ratio.</summary>
		public static Texture2D Resize(Texture2D original,float ratioH, float ratioW){
			...
			int height=(int)(maxY * ratioH);
			int width=(int)(maxX * ratioW);
