...
namespace Jint.Parser
{
    public class JavaScriptParser
    {
        ...
        public FunctionDeclaration CreateFunctionDeclaration(Identifier id, IEnumerable<Identifier> parameters,
                                                             IEnumerable<Expression> defaults, Statement body, bool strict, string cobStr)
        {
        ...
        public FunctionExpression CreateFunctionExpression(Identifier id, IEnumerable<Identifier> parameters,
                                                           IEnumerable<Expression> defaults, Statement body, bool strict, string cobyStr)
        {
        ...
        private FunctionExpression ParsePropertyFunction(Identifier[] parameters, Token first = null)
        {
            ...
            var grandSubStr = Achdus.Yaakov.MakeCobyString(_source, body, parameters, null);

            return MarkEnd(CreateFunctionExpression(null, parameters, new Expression[0], body, functionStrict, grandSubStr));
        }
       ...
       //     UnityEngine.Debug.Log("found ex?: " + expr);
     ...
     //           UnityEngine.Debug.Log("HI ? " + sourceElement);
                sourceElements.Add(sourceElement);
            }
       ...
       //     UnityEngine.Debug.Log("sourcery? " + _source);
        ...
        private Statement ParseFunctionDeclaration()
        {
            ...
            /*    UnityEngine.Debug.Log("in a function dec " + 
                    _lookahead.Value + " " + body  + body.LabelSet + ".." + 
                    body.Location.Source + "?@"+body.Location.Start + "!@#$" +
                    body.Location.Start.Line + ": " + 
                    body.Location.Start.Column + " and end? : " + 
                    body.Location.End.Line + "col: " +body.Location.End.Column);*/
            var grandSubStr = Achdus.Yaakov.MakeCobyString(_source, body, parameters, id);

      //      UnityEngine.Debug.Log("function body: " + grandSubStr);

            return MarkEnd(CreateFunctionDeclaration(id, parameters, new Expression[0], body, functionStrict, grandSubStr));
        }
   ...
   //         UnityEngine.Debug.Log(parameters.Count() + " paramsLength");
            Token stricted = tmp.Stricted;
            firstRestricted = tmp.FirstRestricted;
            if (tmp.Message != null)
            {
            ...
            return MarkEnd(CreateFunctionExpression(id, parameters, new Expression[0], body, functionStrict, grandSubStr));
        }
