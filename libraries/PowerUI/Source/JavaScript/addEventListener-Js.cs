...
namespace Dom{
	...
	public partial class EventTarget{
		...
		public void addEventListener(string name, object jsMethod, bool capture){
			var engine = UI.document.JavascriptEngine.Engine;
            var thisObj = JsValue.FromObject(engine, this);
			addEventListener(name, new JsEventListener(jsMethod, thisObj, engine));
		}

        [JavaScript]
        public void addEventListener(string name, Func<Jint.Native.JsValue, Jint.Native.JsValue[], Jint.Native.JsValue> func, bool use) {
            var engine = UI.document.JavascriptEngine.Engine;
            var thisObj = JsValue.FromObject(engine, this);
            addEventListener(name, new JsEventListener(func, thisObj, engine));
        }
        [JavaScript]
        public void addEventListener(string name, Func<Jint.Native.JsValue, Jint.Native.JsValue[], Jint.Native.JsValue> func) {
            var engine = UI.document.JavascriptEngine.Engine;
            var thisObj = JsValue.FromObject(engine, this);
            addEventListener(name, new JsEventListener(func, thisObj, engine));
        }
        ...
        [JavaScript]
        public void addEventListener(JsValue name, Func<Jint.Native.JsValue, Jint.Native.JsValue[], Jint.Native.JsValue> func) {
            addEventListener(name.AsString(), func, false);
        }
