...
namespace Css{
	...
	public partial class StyleSheet{
		...
		public Achdus.DavarList cssRules=new Achdus.DavarList();
		...
		public void insertRule(string css){
            insertRule(css, 0);
        ...
        public void addRule(string ruleName, string ruleProperty) {
            insertRule(ruleName + "{" + ruleProperty + "}", 0);
        }
