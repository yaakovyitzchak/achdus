...
namespace UTJ.FrameCapturer
{
    ...
    public abstract class MovieEncoder : EncoderBase
    {
        ...
        public abstract void AddVideoFrame(byte[] frame, fcAPI.fcPixelFormat format, string path);
        public abstract void AddAudioSamples(float[] samples);

		public System.Action<string, double> owk = null;
		public void shaymchoot(string s, double ts) {
			if(owk != null) {
				owk(s, ts	);
			}
		}
		
		public System.Collections.Generic.List<string> names = new List<string>();
		public System.Collections.Generic.List<double> times = new List<double>();
