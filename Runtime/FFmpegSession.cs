...
namespace FFmpegOut
{
    public class FFmpegSession : System.IDisposable
    {
        ...
        )
        {
            ...
            return CreateWithOutputPath(
				path, width, height, frameRate, preset,
				derech
			);
        }
        ...
        public static FFmpegSession CreateWithArguments(
			string arguments,
			string derech
		)
        {
            return new FFmpegSession(arguments, derech);
        }
        ...
        public FFmpegSession(string arguments, string derech)
        {
            if (!FFmpegPipe.IsAvailable)
                ...
                _pipe = new FFmpegPipe(arguments, derech);
        }
